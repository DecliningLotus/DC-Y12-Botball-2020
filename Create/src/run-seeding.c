...
void run()
{
    ...
    openClaw(500, 1400);
    spinLeftAngle(100, 107);
    lowerArmBottom(600, 180);

    // Go to communication orb
    moveForwardDistance(300, 105);
    msleep(100);
    ...
    //Pull Minecart
    moveBackwardDistance(100, 190);
    spinRightAngle(100, 45);
    moveForwardDistance(100, 50);
    closeClaw(1400, 500);
    moveBackwardDistance(100, 200);
}